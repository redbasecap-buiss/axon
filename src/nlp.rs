...
const ENTITY_BLACKLIST: &[&str] = &[
    ...
    "revolutionibus",
    "ultramicroscopy",
    // Added 2026-02-24 (brain cleaner round 9): generic words found in DB
    "cattle",
    "memoriam",
    "thalassotherapy",
    "symmetry",
    ...
    "polynomideale",
    "grenzmauer",
    // Added 2026-02-24 (brain cleaner round 11): generic/noise/foreign terms
    "spectrum",
    "dezember",
    "beiträge",
    "mesolabio",
    ...
    "serdaioi",
    "quintilii",
    // Added 2026-02-24 (brain cleaner round 12): generic words cleaned from DB
    "coordinates",
    "membership",
    "ideology",
    "demographics",
    ...
    "flyology",
    "mutilation",
    // Added 2026-02-24 (brain cleaner round 13): generic/demonym/noise
    "oceanic",
    "saharan",
    "scottish",
    "victorian",
    ...
    "like",
    "generals",
    // Added 2026-02-25 (brain cleaner): Hanseatic/academic/generic noise
    "hanseatic",
    "hanse",
    "kogge",
    "kontor",
    ...
    "papyrus",
    "gnomon",
    // Added 2026-02-25 (brain cleaner): generic/academic noise, demonyms, misclassified concepts
    "defensively",
    "dingledy",
    "dumping",
    "encyclopedism",
    ...
    "adds support",
    "further",
    // Added 2026-02-25 (brain cleaner round 2): generic words, demonyms, broken fragments
    "origins",
    "electorate",
    "regions",
    "considerations",
    ...
    "centralism",
    "regionalism",
    // Added 2026-02-25 (brain cleaner round 2): website/brand names, broken compounds
    "yahoo",
    "reddit",
    "quora",
    "pinterest",
    ...
    "form",
    "forms",
    // Added 2026-02-25 (brain cleaner): generic words cleaned from DB audit
    "deposed",
    "disputes",
    "doubts",
    "dukedoms",
    ...
    "amphictyony",
    "ngarrindjeri",
    // Added 2026-02-25 (brain cleaner): single-word noise, demonyms, tech brands
    "agora",
    "almagest",
    "arithmetica",
    "bibliotheke",
    ...
    "thoughtco",
    "sefaria",
    // Added 2026-02-25 (brain cleaner): generic words, broken patterns, demonyms
    "proof",
    "disappointed",
    "reissued",
    "parisian",
...
const CONCEPT_INDICATORS: &[&str] = &[
    ...
    "simply",
    "warriors",
    // Added 2026-02-25 (brain cleaner): generic nouns/adjectives leaking as concepts
    "oceans",
    "computer",
    "advantages",
    "eunuch",
...
const GENERIC_SINGLE_WORDS: &[&str] = &[
    ...
    "ballistics",
    "admiralty",
    // Added 2026-02-25 (brain cleaner): more generic single-word noise
    "dioceses",
    "direction",
    "differences",
    "education",
    ...
    "aramaic",
    "koine",
    // Added 2026-02-25 (brain cleaner): single-word concepts cleaned from DB
    "deposed",
    "disputes",
    "doubts",
    "dukedoms",
...
fn classify_entity_type(name: &str) -> &'static str {
    ...
    const KNOWN_PLACES: &[&str] = &[
        ...
        "pentagon",
        "grenoble",
        // Added 2026-02-25 (brain cleaner round 4): Hanseatic/Baltic places
        "riga",
        "tallinn",
        "tartu",
        "pskov",
        ...
        "rosaspata",
        "samnium",
        // Added 2026-02-24 (brain cleaner round 9)
        "quillota",
        "wijdefjorden",
        "nanjing",
        "qullasuyu",
        ...
        "antisuyu",
        "cacán",
        // Added 2026-02-24 (brain cleaner round 13): Timbuktu-area and misc places
        "kabara",
        "kairouan",
        "korioumé",
        "koulikoro",
            ...
            .all(|w| w.chars().next().is_some_and(|c| c.is_uppercase()))
    {
        ...
        if name.split_whitespace().all(|w| w.len() < 15) {
            ...
            const NOT_PERSON_WORDS: &[&str] = &[
                ...
                "crusader",
                "lit",
                // Added 2026-02-24: more not-person words from DB analysis
                "game",
                "games",
                "patent",
                "patents",
                ...
                "corollary",
                "axiom",
                // Added 2026-02-25 (brain cleaner): more not-person words
                "infrastructure",
                "subsystem",
                "shuttle",
                "shuttles",
